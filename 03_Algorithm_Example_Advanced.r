...
#STEP 3/4: Rename the file using the convention: [emailID]-datapipeline. For example: joverton-advancedalgorithm
#STEP 4/4: Clear any previous output: Kernel -> Restart & Clear the Output

#EXERCISE:

#Clear the results of the code: Kernel -> Restart & Clear Output
#Follow along with the logic as you run each cell
